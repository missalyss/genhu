...
class Navbar extends React.Component {
  ...
  componentDidMount() {
    axios.get("/api/orphanages").then(res => {
  ...
  renderO = () => {
    ...
    return (
      <>
        {orphanages.map(o => (
          <div key={o.id} {...o}>
            <Link to={{ pathname: `/orphanages/${o.id}` }} {...o}>
              {o.name}
            </Link>
          </div>
  ...
  renderC = () => {
    ...
    return (
      <>
        {centers.map(c => (
          <div key={c.id} {...c}>
            <Link to={{ pathname: `/centers/${c.id}` }} {...c}>
              {c.name}
            </Link>
          </div>
        ))}
    ...
    return (
      <div className="main-nav">
        ...
        <div className="right_nav">
          ...
          <NavLink to="/expeditions" className="nav-item">
            Expeditions
          </NavLink>
          <div className="dropdown">
            <NavLink to="#" className="nav-item" style={{ cursor: "default" }}>
              Homes & Projects
            </NavLink>
            <div className="dropdown-content">
              <NavLink to="/orphanages">Orphanages</NavLink>
              <div className="homes-tab">{this.renderO()}</div>
              <NavLink to="/drop_in_centers">Drop-In Centers</NavLink>
              <div className="homes-tab">{this.renderC()}</div>
            </div>
          </div>
          ...
          <a href="https://www.facebook.com/genhu.org/" target="_blank">
            <Image src={Facebook} className="facebook-image" alt="facebook" />
          </a>
        </div>
      </div>
    );
